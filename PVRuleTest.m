function accuracy_array = PVRuleTest(training_data, training_label, zv_max)
...
for class1 = 0:5
    for class2 = class1+1 : 5  
        ...
        for z = 0.6:0.05:zv_max
            z
            predict = zeros(test_size, 1);
            success = 0;
            k_avg = 0;
            for i=1:test_size
                [predict(i), k] = pVRule(x1, x2, z, test_data(i,:), classes);
